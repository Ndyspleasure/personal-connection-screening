...
const PUBLIC_MESSAGES: Record<ErrorCode, string> = {
  ...
  ACCESS_CODE_INVALID: 'That access code is not valid.',
  ACCESS_CODE_EXPIRED: 'That access code is no longer valid.',
  ACCESS_CODE_EXHAUSTED: 'That access code has reached its usage limit.',
